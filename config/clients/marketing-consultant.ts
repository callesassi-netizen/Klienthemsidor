...
export const marketingConsultant: ClientEntry = {
  id: 'marketing-consultant',
  label: 'Elevate Growth Co.',
  config: {
    ...
    faq: [
      {
        ...
        answer: 'Most clients see measurable improvements within 30–60 days. Full impact is typically evident by month 3.',
      },
      {
        question: 'Do you require long-term contracts?',
        answer: 'No. We work month-to-month. We earn your business every month.',
      },
      {
        question: 'What industries do you work with?',
        answer: 'We specialise in service businesses — legal, home services, SaaS, healthcare, and B2B.',
      },
      {
        question: 'What does the free strategy call include?',
        answer: 'A 30-minute live session where we analyse your current marketing and identify your biggest growth opportunities. No sales pitch.',
      },
    ],
