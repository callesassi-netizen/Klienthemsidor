...
export const siteConfig: SiteConfig = {
  ...
  faq: [
    { question: 'Do you take walk-in appointments?', answer: 'We recommend booking in advance, but we do accommodate walk-ins based on availability. Call us first to check.' },
    { question: 'What colour brands do you use?', answer: 'We use Schwarzkopf Professional, Wella Professionals, and Olaplex for all colour and treatment services.' },
    { question: 'Do you offer a patch test for colour services?', answer: 'Yes — patch tests are required 48 hours before any first colour service. We\'ll arrange this at a quick complimentary visit.' },
    { question: 'Is parking available?', answer: 'Yes, free street parking is available directly outside the studio, plus a multi-storey car park 2 minutes away.' },
  ],
